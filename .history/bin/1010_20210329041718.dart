...
String listTwo;
  ...
  List<String> listTwoSplit = listOne.split(' ');
  productOneCode = int.parse(listTwoSplit[0]);
  productOneUnits = int.parse(listTwoSplit[1]);
  productOnePrice = double.parse(listTwoSplit[2]);
