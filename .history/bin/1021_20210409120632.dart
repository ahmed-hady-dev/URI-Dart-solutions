...
void main() {
  ...
  print('MOEDAS:');
  print("${input ~/ } moeda(s) de R\$ 1.00");
  input %= 100;
  print("${input ~/ 50} moeda(s) de R\$ 0.50");
  input %= 50;
  print("${input ~/ 20} moeda(s) de R\$ 0.25");
  input %= 20;
  print("${input ~/ 10} moeda(s) de R\$ 0.10");
  input %= 10;
  print("${input ~/ 5} moeda(s) de R\$ 0.05");
  input %= 5;
  print("${input ~/ 2} moeda(s) de R\$ 0.01");
}
